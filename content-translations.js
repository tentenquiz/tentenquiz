        ...
        'zh-CN': {
            about: page(
                ...
                [
                    ...
                    s('3. 如何学习？', `<ul><li>普通测验每轮最多10题。</li><li>在“错题练习”中重新解答答错或超时的问题。</li><li>把重要单词加入“我的单词本”，直到主动停止前持续循环。</li><li>答错或超时后立即显示正确答案。</li><li>完成主题25题和10题全对时会显示不同的庆祝效果。</li></ul>`),
            ...
            guide: page(
                '学习指南 | TentenQuiz',
                '介绍TentenQuiz阶段、主题测验、错题练习、我的单词本、音频和加密学习记录备份的使用方法。',
                'TentenQuiz学习指南',
                '面向新学习者的分步说明',
                ...
                [
                    ...
                    s('4. 错题练习', `<ol><li>答错和超时的问题自动保存。</li><li>在当前阶段打开“错题练习”。</li><li>重新答对后，该词从列表删除。</li><li>再次答错则保留，供下次复习。</li></ol><p>建议在大量学习新内容之前，先把错题数量降到0。</p>`),
                    ...
                    s('6. 推荐复习流程', `<ol><li>完成10道新题。</li><li>立即进行错题练习。</li><li>把易混淆或重要的词加入单词本。</li><li>完成同一主题的25个词。</li><li>第二天短时间重复单词本。</li></ol><p>定期进行短时间学习，比一次完成整个阶段更重要。</p>`),
                    ...
                    s('8. 常见问题', `<h3>同一阶段可以混合学习不同主题吗？</h3><p>可以。每个主题的25个词分别记录。</p><h3>切换语言后记录会混合吗？</h3><p>不会。记录按自己的语言、学习语言和阶段分开。</p><h3>答错也计入主题进度吗？</h3><p>进度表示已经尝试过该词。答错的词仍留在错题练习中，建议继续复习到答对。</p><h3>听不到声音怎么办？</h3><p>检查媒体音量和浏览器网站静音。有些浏览器首次播放前需要先点击页面。</p><h3>可以像应用一样安装吗？</h3><p>在支持的浏览器中使用小型安装提示，之后可通过桌面快捷方式或主屏幕图标启动。</p>`),
